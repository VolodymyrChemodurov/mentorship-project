...
import com.training.weather.ingestor.infrastructure.util.owm.mapper.OwmRedisMapper;
...
public class OwmRedisMapperTest {
  ...
  public void mapShouldSuccess(){
    List<WeatherForecastWrapper> result = owmRedisMapper.map(OWM_RESPONSE);
  ...
  public void mapShouldReturnSuccessIfCloudsEqualNull(){
    ...
    List<WeatherForecastRedisWrapper> result = owmRedisMapper.map(OWM_RESPONSE);
